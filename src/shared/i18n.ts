...
Object.assign(contextMenuTranslations, {
  "es-ES": {
    ...
    showHide: "Mostrar/ocultar JiaorongAI",
  },
  "de-DE": {
    copy: "Kopieren",
    paste: "Einfügen",
    ...
    showHide: "JiaorongAI ein-/ausblenden",
  },
  "tr-TR": {
    copy: "Kopyala",
    paste: "Yapıştır",
    ...
    showHide: "JiaorongAI'i göster/gizle",
  },
  "id-ID": {
    copy: "Salin",
    paste: "Tempel",
    ...
    showHide: "Tampilkan/sembunyikan JiaorongAI",
  },
  "ms-MY": {
    copy: "Salin",
    paste: "Tampal",
    ...
    showHide: "Tunjuk/sembunyikan JiaorongAI",
  },
  "it-IT": {
    copy: "Copia",
    paste: "Incolla",
    ...
    showHide: "Mostra/nascondi JiaorongAI",
  },
  "pl-PL": {
    copy: "Kopiuj",
    paste: "Wklej",
    ...
    showHide: "Pokaż/ukryj JiaorongAI",
  },
  "vi-VN": {
    copy: "Sao chép",
    paste: "Dán",
...
export const errorMessageTranslations: Record<string, TranslationMap> = {
  ...
  "zh-TW": {
    ...
    addMcpServerDuplicateMessage:
      '服務器名稱 "{serverName}" 已存在。請選擇一個不同的名稱。',
    getMcpToolListErrorTitle: "獲取工具定義失敗",
    getMcpToolListErrorMessage:
      "無法從服務器 '{serverName}' 獲取工具列表: {errorMessage}",
  ...
  "en-US": {
    ...
    needAtLeastOneDifyConfig:
      "Need to provide at least one Dify knowledge base configuration",
  ...
  ja: {
    ...
    needAtLeastOneRagflowConfig:
      "少なくとも1つのRAGFlowの知識ベースの設定を提供する必要があります",
    needAtLeastOneDifyConfig:
      "少なくとも1つのDifyの知識ベースの設定を提供する必要があります",
    needRagflowApiKey: "RAGFlowのAPIキーを提供する必要があります",
    needDifyApiKey: "DifyのAPIキーを提供する必要があります",
    needRagflowDatasetIds:
      "少なくとも1つのRAGFlowのデータセットIDを提供する必要があります",
  ...
  ko: {
    ...
    needAtLeastOneRagflowConfig:
      "최소 하나의 RAGFlow 지식 베이스 구성을 제공해야 합니다",
    needAtLeastOneDifyConfig:
      "최소 하나의 Dify 지식 베이스 구성을 제공해야 합니다",
  ...
  fr: {
    ...
    getMcpToolListErrorTitle:
      "Échec de la récupération des définitions d'outils",
    getMcpToolListErrorMessage:
    ...
    needRagflowConfig:
      "Vous devez fournir la configuration de la base de connaissances RAGFlow",
    needDifyConfig:
      "Vous devez fournir la configuration de la base de connaissances Dify",
    needAtLeastOneRagflowConfig:
    ...
    needRagflowDatasetIds:
      "Vous devez fournir au moins un identifiant de jeu de données RAGFlow",
    needDifyDatasetId:
      "Vous devez fournir l'identifiant de jeu de données Dify",
  ...
  de: {
    ...
    needRagflowConfig:
      "RAGFlow-Konfigurationsdaten müssen bereitgestellt werden",
    ...
    needAtLeastOneDifyConfig:
      "Es muss mindestens eine Dify-Konfiguration bereitgestellt werden",
    needRagflowApiKey:
      "Es muss ein RAGFlow-API-Schlüssel bereitgestellt werden",
    needDifyApiKey: "Es muss ein Dify-API-Schlüssel bereitgestellt werden",
    needRagflowDatasetIds:
      "Es muss mindestens eine RAGFlow-Dataset-ID bereitgestellt werden",
  ...
  es: {
    ...
    getMcpToolListErrorTitle:
      "Error al obtener las definiciones de herramientas",
    getMcpToolListErrorMessage:
    ...
    needRagflowConfig:
      "Se deben proporcionar los datos de configuración de RAGFlow",
    needDifyConfig: "Se deben proporcionar los datos de configuración de Dify",
    needAtLeastOneRagflowConfig:
      "Se debe proporcionar al menos una configuración de RAGFlow",
    needAtLeastOneDifyConfig:
      "Se debe proporcionar al menos una configuración de Dify",
    ...
    needDifyDatasetId:
      "Se debe proporcionar el identificador de conjunto de datos de Dify",
  ...
  "pt-BR": {
    ...
    needRagflowConfig:
      "É necessário fornecer a configuração da base de conhecimento RAGFlow",
    needDifyConfig:
      "É necessário fornecer a configuração da base de conhecimento Dify",
    needAtLeastOneRagflowConfig:
    ...
    needRagflowDatasetIds:
      "É necessário fornecer pelo menos um ID de conjunto de dados do RAGFlow",
    needDifyDatasetId:
      "É necessário fornecer o ID do conjunto de dados do Dify",
...
Object.assign(errorMessageTranslations, {
  "es-ES": {
    ...
    getMcpToolListErrorTitle:
      "No se pudieron obtener las definiciones de herramientas",
    getMcpToolListErrorMessage:
      "No se pudo recuperar la lista de herramientas del servidor '{serverName}': {errorMessage}",
    genericErrorTitle: "Error",
    genericErrorMessage: "Se ha producido un error",
    needRagflowConfig:
      "Debes proporcionar la configuración de la base de conocimiento RAGFlow",
    needDifyConfig:
      "Debes proporcionar la configuración de la base de conocimiento Dify",
    needAtLeastOneRagflowConfig:
    ...
    needRagflowDatasetIds:
      "Debes proporcionar al menos un Dataset ID de RAGFlow",
  ...
  "de-DE": {
    ...
    needRagflowConfig:
      "Die Konfiguration der RAGFlow-Wissensdatenbank muss angegeben werden",
    needDifyConfig:
      "Die Konfiguration der Dify-Wissensdatenbank muss angegeben werden",
    needAtLeastOneRagflowConfig:
    ...
    needRagflowDatasetIds:
      "Mindestens eine RAGFlow Dataset ID muss angegeben werden",
  ...
  "tr-TR": {
    ...
    needAtLeastOneRagflowConfig:
      "En az bir RAGFlow bilgi tabanı yapılandırması sağlanmalıdır",
    needAtLeastOneDifyConfig:
      "En az bir Dify bilgi tabanı yapılandırması sağlanmalıdır",
  ...
  "id-ID": {
    ...
    addMcpServerDuplicateMessage:
      'Nama server "{serverName}" sudah ada. Pilih nama lain.',
    ...
    needAtLeastOneDifyConfig:
      "Setidaknya satu konfigurasi basis pengetahuan Dify perlu disediakan",
    needRagflowApiKey: "API Key RAGFlow perlu disediakan",
    needDifyApiKey: "API Key Dify perlu disediakan",
    needRagflowDatasetIds:
      "Setidaknya satu Dataset ID RAGFlow perlu disediakan",
  ...
  "ms-MY": {
    ...
    addMcpServerDuplicateMessage:
      'Nama pelayan "{serverName}" sudah wujud. Sila pilih nama lain.',
    getMcpToolListErrorTitle: "Gagal mendapatkan definisi alat",
    getMcpToolListErrorMessage:
    ...
    needRagflowConfig:
      "Konfigurasi pangkalan pengetahuan RAGFlow perlu diberikan",
    ...
    needRagflowDatasetIds:
      "Sekurang-kurangnya satu Dataset ID RAGFlow perlu diberikan",
  ...
  "it-IT": {
    ...
    addMcpServerDuplicateMessage:
      'Il nome server "{serverName}" esiste già. Scegli un altro nome.',
    getMcpToolListErrorTitle:
      "Impossibile ottenere le definizioni degli strumenti",
    getMcpToolListErrorMessage:
    ...
    needRagflowConfig:
      "Devi fornire la configurazione della base di conoscenza RAGFlow",
    needDifyConfig:
      "Devi fornire la configurazione della base di conoscenza Dify",
    needAtLeastOneRagflowConfig:
  ...
  "pl-PL": {
    ...
    addMcpServerDuplicateMessage:
      'Nazwa serwera "{serverName}" już istnieje. Wybierz inną nazwę.',
    ...
    needAtLeastOneRagflowConfig:
      "Wymagana jest co najmniej jedna konfiguracja bazy wiedzy RAGFlow",
    needAtLeastOneDifyConfig:
      "Wymagana jest co najmniej jedna konfiguracja bazy wiedzy Dify",
  ...
  "vi-VN": {
    ...
    addMcpServerDuplicateMessage:
      'Tên máy chủ "{serverName}" đã tồn tại. Vui lòng chọn tên khác.',
    ...
    needAtLeastOneRagflowConfig:
      "Cần cung cấp ít nhất một cấu hình cơ sở kiến thức RAGFlow",
    needAtLeastOneDifyConfig:
      "Cần cung cấp ít nhất một cấu hình cơ sở kiến thức Dify",
