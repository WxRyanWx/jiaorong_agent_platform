<!--
  ...
  状态由 useJiaorongAgentRuntime 驱动，客户端走 Node WebSocket。
-->
...
import { findPendingQuestion, findPendingToolPermission } from './lib/hostParse'
import { isUserCanceledError, localizeErrorText } from '../../lib/errorText'
import type {
  AgentPlanItem,
...
defineExpose({
  ...
  getClient: (): NodeClient | null => runtime.getClient(),
  ready
})
</script>
