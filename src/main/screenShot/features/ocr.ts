...
import { getFeaturePreloadPath, getScreenshotFeatureHtmlPath, showAlwaysOnTop } from './windowUtils'
...
const createOcrResultWindow = (imageBase64: string): BrowserWindow => {
  ...
  win.loadFile(getScreenshotFeatureHtmlPath('ocr.html')).catch((error) => {
