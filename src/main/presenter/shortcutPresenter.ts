    ...
    if (process.platform === "darwin") {
      template.push({
        ...
        submenu: [
          ...
          { role: "unhide" },
          { type: "separator" },
          this.createCommandItem(labels.quit, this.shortcutKeys.Quit, () =>
            app.quit(),
          ),
        ],
      });
    ...
    template.push(
      {
        ...
        submenu: [
          this.createCommandItem(
            ...
            this.shortcutKeys.NewConversation,
            () =>
              this.sendChatWindowShortcut(
      ...
      },
      {
        ...
        submenu: [
          this.createCommandItem(
            labels.quickSearch,
            this.shortcutKeys.QuickSearch,
            () => this.openQuickSearch(),
          ),
          this.createCommandItem(
            labels.toggleSidebar,
            this.shortcutKeys.ToggleSidebar,
            () =>
              this.sendFocusedChatWindowShortcut(
                SHORTCUT_EVENTS.TOGGLE_SIDEBAR,
              ),
          ),
          this.createCommandItem(
            labels.toggleWorkspace,
            this.shortcutKeys.ToggleWorkspace,
            () =>
              this.sendFocusedChatWindowShortcut(
          ...
          { type: "separator" },
          this.createCommandItem(
            labels.cleanChatHistory,
            this.shortcutKeys.CleanChatHistory,
            () =>
              this.sendFocusedChatWindowShortcut(
