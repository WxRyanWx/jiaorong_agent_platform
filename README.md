...
- The black-box runner owns the complete 142-case inventory from the frozen conformance matrix. It currently executes six matrix cases plus the static asset gate and reports the other cases as missing, so it deliberately exits non-zero instead of claiming full conformance.
