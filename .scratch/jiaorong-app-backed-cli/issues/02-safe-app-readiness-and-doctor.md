...
- Real production command `./bin/jiaorong-cli.mjs doctor --output-format json`: exit 0; `ok=true`; installed app version `0.5.6`; endpoint `127.0.0.1:9238`; one available enabled model; all ten readiness checks passed.
- App identity is gated by bundle ID `com.wefonk.jiaorong`, exact bundle/bridge version `0.5.6`, `app.asar` SHA-256 `46c10c761eb3c70f461061cbd80ad1c0cc2796aea29574e73cd85d445f1b22aa`, exact executable path, listener PID and loopback bind, CDP product metadata, renderer URL/target identity, and a trusted bridge manifest pinned to upstream source revision `d2a7d3fe6a525a8b33633f8851afb44cf6ccc8c3`.
