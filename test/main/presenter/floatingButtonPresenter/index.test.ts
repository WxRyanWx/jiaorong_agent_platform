...
vi.mock(
  "../../../../src/main/presenter/floatingButtonPresenter/FloatingButtonWindow",
  () => ({
    FloatingButtonWindow: class MockFloatingButtonWindow {
      ...
      constructor() {
        floatingWindowState.instance =
          this as unknown as typeof floatingWindowState.instance;
      }
    },
  }),
);
...
describe("FloatingButtonPresenter drag layout sync", () => {
  ...
  it("keeps the collapsed size stable when dragging interrupts collapse animation", async () => {
    ...
    expect(floatingWindowState.bounds.width).toBeGreaterThan(
