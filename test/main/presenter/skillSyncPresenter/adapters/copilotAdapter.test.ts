...
# Instructions`;
    ...
    it("should map Copilot tools to JiaorongAI format", () => {
      const content = `---
...
Also see #file:'rules/coding.md' for coding rules.`;
      ...
      expect(result.instructions).toContain(
        "${SKILL_ROOT}/references/docs/api.md",
      );
      expect(result.instructions).toContain(
        "${SKILL_ROOT}/references/rules/coding.md",
      );
    });
...
Content`;
  ...
  describe("serialize", () => {
    ...
    it("should map JiaorongAI tools to Copilot format", () => {
      const skill: CanonicalSkill = {
        name: "test",
        description: "Test",
        instructions: "Content",
