...
When users send prompts such as `生成 马斯克 喝酒的视频 2s` to OpenAI-compatible video models, JiaorongAI should preserve the obvious structured duration hint instead of sending only the raw prompt body.
